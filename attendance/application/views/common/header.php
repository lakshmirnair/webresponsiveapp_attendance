...
header("Access-Control-Allow-Methods: GET, OPTIONS");
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>public_html/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>public_html/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>public_html/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <!-- Google Font -->
